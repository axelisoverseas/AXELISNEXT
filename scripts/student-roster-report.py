...
"- **Sai Vikas — confirmed.** Kept. His university is still unresolved: Maynooth in SEP'24,",
"  DePaul in the master sheet. Pick one before he appears anywhere.",
...
"name is used.","",
"**Spelling.** The same student is spelled two ways across sheets: *Ishaan Malik / Ishaan Maalik*",
"and *Rajat Limaye / Rajat Limayee*. Merged as one person each; pick the correct spelling.","",
"**Two rows are still mis-parsed** in the incentive sheet, a column slipped:",
"*Shivam Tamrakar* (university reads `Sid`, course reads `Saee`) and *Ishaan Malik*",
"(university reads `Saee`).","",
