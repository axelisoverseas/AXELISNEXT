      ...
      <div className="bg-white rounded-lg shadow-e-3 p-4 border border-gray-200 min-w-[320px] max-w-[400px]">
        ...
        <div className="mb-3">
          ...
          <button
            ...
            className="w-full mt-2 px-3 py-1 bg-[var(--color-axelis)] hover:bg-[var(--color-navy)] disabled:bg-gray-400 text-white rounded text-sm flex items-center justify-center"
          >
            {sendingCustom ? (
              <>
