...
// Animation controller drives the canvas via a gsap timeline.
class AnimationController {
  ...
  // Deterministic seed so the spiral looks identical on every load.
...
export function SpiralAnimation() {
  ...
  // Start null so we defer any window reads to useEffect (SSR-safe).
