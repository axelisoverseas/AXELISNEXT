        ...
        <div className="bg-slate-50 min-h-screen py-24">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <span className="inline-block px-6 py-2 bg-stone-100 text-stone-900 font-bold rounded-full mb-4.5 border border-stone-200">
                        Preview
                    </span>
                    <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 leading-tight">
                        Transclucent Tracking <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-stone-900 to-stone-800">Student Portal Tracker</span>
                    </h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                            ...
                            <div className="lg:col-span-2">
                                <h4 className="text-lg font-bold text-slate-800 mb-6 flex items-center">
                                    <Clock className="w-5 h-5 mr-2 text-stone-900" /> Application Journey
                                </h4>

                                <div className="relative pl-8 space-y-8 before:absolute before:inset-0 before:ml-[1.1rem] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-green-500 before:via-stone-300 before:to-gray-200">
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <div className="flex items-center gap-3">
                                                        <div className={`p-2 rounded-lg ${step.status === 'completed' ? 'bg-green-100 text-green-600' :
                                                                step.status === 'current' ? 'bg-stone-100 text-stone-900' :
