...
export default function SpecimenCertificate({ programmeTitle = 'Global Career Launch' }) {
  return (
    <div
      ...
      className="relative overflow-hidden rounded-2xl border-2 border-[var(--color-axelis)]/30 bg-gradient-to-br from-[#12436E] to-[#0E3557] p-6 sm:p-10 md:p-14 shadow-e-lift"
    >
