  ...
  useEffect(() => {
    ...
    function showFallback() {
      globeContainer.innerHTML = `
        <div class="flex items-center justify-center h-full bg-gradient-to-br from-stone-900 to-stone-900 rounded-2xl">
          <div class="text-center text-white p-8">
            <div class="w-24 h-24 mx-auto mb-4 bg-stone-700/20 rounded-full flex items-center justify-center">
            ...
            <p class="text-stone-200">Connecting students worldwide</p>
          </div>
        </div>
      `;
    }
