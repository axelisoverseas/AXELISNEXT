...
const PRIMARY =
  'inline-flex w-full items-center justify-center px-4 py-3 rounded-xl font-bold text-sm transition-all bg-gradient-to-r from-[var(--storm-accent)] to-[var(--dawn-glow)] hover:brightness-110 text-white shadow-e-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-axelis)]';
